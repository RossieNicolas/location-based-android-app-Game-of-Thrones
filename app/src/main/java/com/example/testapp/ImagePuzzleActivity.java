...
public class ImagePuzzleActivity extends AppCompatActivity {
    ...
    private class AnswersAdapter extends RecyclerView.Adapter<AnswersAdapter.MyViewHolder>{
        ...
        public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int position) {
            final Context context = ImagePuzzleActivity.this;
            ...
            myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (puzzle.getAnswerForImage(myViewHolder.getAdapterPosition())){
                        ...
                        Intent show = new Intent(context, Question3RightActivity.class);
                        startActivity(show);

                    }else {
                        storyLine.currentTask().finish(true);
                        Intent show = new Intent(context, Question3WrongActivity.class);
                        startActivity(show);
                    }
                }
            });
