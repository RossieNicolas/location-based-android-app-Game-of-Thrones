...
public class SimplePuzzleActivity2 extends AppCompatActivity {
    ...
    private void checkAnswer(){
        ...
        if (userAnswer.equalsIgnoreCase(correctAnswer)){
            ...
            Intent show = new Intent(this, Question2RightActivity.class);
            startActivity(show);

        }
        else {
            storyLine.currentTask().finish(true);
            Intent show = new Intent(this, Question2WrongActivity.class);
            startActivity(show);
